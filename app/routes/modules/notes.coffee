...
module.exports = (app) ->
	...
	app.get '/modules/notes/notes', (ensureLoggedIn '/'), (req, res) ->
		Note.get (err, notes) ->
			res.json
				errors: if err then [err] else []
				notes: notes

	app.post '/modules/notes/add-or-edit', (ensureLoggedIn '/'), (req, res) ->
	...
	app.post '/modules/notes/del', (ensureLoggedIn '/'), (req, res) ->
